...
export default function MessagesPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="flex max-w-[1400px] mx-auto">
        ...
        <main className="flex-1 px-6">
          ...
          <div className="border-b border-gray-200 py-4 flex items-center gap-4">
            ...
            {['Recycling bin', 'Mark Unread', 'Mark Read', 'Report', 'Archive'].map((action) => (
              <button
                key={action}
          ...
          <div className="flex flex-col items-center justify-center py-24">
            ...
            >
              <path
                ...
                stroke="#D1D5DB" strokeWidth="2" strokeLinecap="round" strokeDasharray="4 4"
              />
              <path
      ...
      {/* FAB */}
      <button
        className="fixed bottom-8 right-8 w-14 h-14 rounded-full bg-[#222222] flex items-center justify-center shadow-lg hover:shadow-xl transition-shadow"
        aria-label="Starred messages"
      >
        <Star className="h-7 w-7 fill-[#F1C744] text-[#F1C744]" />
      </button>

      {/* Footer bar */}
      <footer className="fixed bottom-0 left-0 right-0 h-16 bg-[#2952CC]" />
    </div>
  );
}