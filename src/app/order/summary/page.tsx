...
export default function OrderSummaryPage() {
  ...
  // Handle payment confirmation - redirect to Paystack if payment_url exists
  const handleConfirmPayment = async () => {
    if (!order) return;

    // If we already have a payment URL from the order creation, use it directly
    if (order.payment_url) {
      console.log("[OrderSummary] Redirecting to Paystack:", order.payment_url);
      window.location.href = order.payment_url;
      return;
    }

    // If no payment URL, try to initialize payment again (fallback)
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          <Loader2
            size={48}
            className="animate-spin text-[#F1641E] mx-auto mb-4"
          />
                ...
                <div>
                  ...
                  <p className="text-sm font-medium text-gray-700 mt-2">
                    ...
                    <span className="text-[#F1641E]">
                      {selectedDelivery.estimated_days}
                    </span>
                  </p>
                  {selectedDelivery.carrier && (
                    <p className="text-xs text-gray-400 mt-1">
                      Fulfilled by {selectedDelivery.carrier}
                    </p>
                  )}
                </div>
                <button
              ...
              {showDeliveryOptions && (
                <div className="mt-4 border-t border-gray-100 pt-4 space-y-3">
                    ...
                    >
                      <div className="flex-1">
                        ...
                        <p className="text-xs text-gray-400 ml-6">
                          Delivery: {option.estimated_days}
                        </p>
                        {option.carrier && (
                          <p className="text-xs text-gray-400 ml-6">
                            {option.carrier}
                  ...
                  <p className="text-xs text-green-600 mt-2">
                    SAVE UP TO ₦{" "}
                    {(
                      DELIVERY_OPTIONS[0].price - DELIVERY_OPTIONS[1].price
                    ).toLocaleString()}
                  </p>
                </div>
              )}
              ...
              <div className="mt-4 pt-4 border-t border-gray-100">
                ...
                <div className="bg-gray-50 rounded-xl p-3">
                  <div className="flex items-center gap-2 text-xs text-gray-500 mb-2">
                    <Truck size={12} />
                    <span>
                      Fulfilled by {selectedDelivery.carrier || "JUMIA"}
                    </span>
                    <span className="mx-1">•</span>
                    <span>Door Delivery</span>
                  </div>
                  <p className="text-xs text-gray-500 mb-2">
                    Delivery scheduled on {selectedDelivery.estimated_days}
                  </p>
            ...
            <div className="bg-white rounded-2xl border border-gray-200 p-6 shadow-sm hover:shadow-md transition-shadow">
              ...
              <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-xl border border-gray-200">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500">
                    You can Pay with cards via Paystack
                  </p>
                </div>
            ...
            <div className="sticky top-24 space-y-4">
              ...
              <div className="bg-white rounded-2xl border border-gray-200 p-6 shadow-sm">
                ...
                <div className="space-y-3">
                  <div className="flex justify-between text-sm">
                    <span className="text-gray-600">
                      Item's total ({order.items.length})
                    </span>
                ...
                <p className="text-xs text-gray-400 text-center">
                  * Learn more about additional taxes, duties, and fees that may
                  apply
                </p>
              </div>
              ...
              <p className="text-xs text-gray-400 text-center">
                ...
                <a href="/terms" className="text-[#F1641E] hover:underline">
                  Terms & Conditions
                </a>
              </p>
            </div>
